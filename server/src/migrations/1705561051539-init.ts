...
export class Init1705561051539 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "voices" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "source" character varying, "playTime" bigint NOT NULL, "anchorId" integer, CONSTRAINT "PK_e9aca1140ce459e098f259fcc47" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "emoticon_tag" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "anchorId" integer, CONSTRAINT "PK_4ae88ba2fcd3044cc6bacab0788" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "emoticons" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "source" character varying, "anchorId" integer, CONSTRAINT "PK_54d4808a3f59e8faae332a906c7" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "anchor" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "anchorName" character varying NOT NULL, "anchorTitle" character varying NOT NULL, "pathName" character varying NOT NULL, "biliId" integer, "biliveId" integer, "lastVideoBV" character varying, "primaryColor" character varying, "secondColor" character varying, "primaryColorDark" character varying, "secondColorDark" character varying, "btnColor" character varying, CONSTRAINT "PK_8cba1ff69c3a6b412d36f4e9db7" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_b5abce0a6d2a772fe933e84cc0" ON "anchor" ("pathName") `
    )
    await queryRunner.query(
      `CREATE TABLE "voice_tag" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "anchorId" integer, CONSTRAINT "PK_85f7c03636f3f9014180f72a1db" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "role" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "roleStr" character varying NOT NULL, "userId" integer, "groupId" integer, CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "user_group" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying, CONSTRAINT "PK_3c29fba6fe013ec8724378ce7c9" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "nickName" character varying, "phone" character varying, "mail" character varying, "pass" character varying, "salt" character varying, "groupId" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    )
    ...
    await queryRunner.query(
      `CREATE TABLE "mail_encode" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "mail" character varying NOT NULL, "code" integer NOT NULL, "expirTime" TIMESTAMP NOT NULL, "hasUsed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_d71b114a91b0b2e1a063968373d" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_244fd198a2237b1cd7a20a9a17" ON "mail_encode" ("mail") `
    )
    await queryRunner.query(
      `CREATE TABLE "phone_encode" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "phone" character varying NOT NULL, "code" integer NOT NULL, "expirTime" TIMESTAMP NOT NULL, "hasUsed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_7bd40672bd672bc3b032c03a665" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
