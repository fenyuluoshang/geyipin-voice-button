...
export class Init1705561051539 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."emoticons_status_enum" AS ENUM('0', '2', '1')`)
    await queryRunner.query(
      `CREATE TABLE "emoticons" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "uploaderId" integer, "status" "public"."emoticons_status_enum" NOT NULL DEFAULT '0', "title" character varying NOT NULL, "source" character varying, "anchorId" integer, CONSTRAINT "PK_54d4808a3f59e8faae332a906c7" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE TYPE "public"."voices_status_enum" AS ENUM('0', '2', '1')`)
    await queryRunner.query(
      `CREATE TABLE "voices" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "uploaderId" integer, "status" "public"."voices_status_enum" NOT NULL DEFAULT '0', "title" character varying NOT NULL, "source" character varying, "playTime" bigint NOT NULL DEFAULT 0, "anchorId" integer, CONSTRAINT "PK_e9aca1140ce459e098f259fcc47" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "emoticons" ADD CONSTRAINT "FK_8cc6edbd9d23d713c5833240581" FOREIGN KEY ("uploaderId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "voices" ADD CONSTRAINT "FK_9fbe87f2b5efff7be9542ceba08" FOREIGN KEY ("uploaderId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "voices" DROP CONSTRAINT "FK_9fbe87f2b5efff7be9542ceba08"`)
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "emoticons" DROP CONSTRAINT "FK_8cc6edbd9d23d713c5833240581"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TYPE "public"."emoticons_status_enum"`)
